            ...
            public void onMapReady(@NonNull MapboxMap mapboxMap) {
                ...
                mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        offlineManager = OfflineManager.getInstance(Test.this);
...
//
//        final EditText regionNameEdit = new EditText(Test.this);
...
//                            Toast.makeText(Test.this, getString(R.string.dialog_toast), Toast.LENGTH_SHORT).show();
//                        } else {
...
//        builder.show();
        ...
        final EditDialog editDialog = new EditDialog(Test.this);
        editDialog.setTitle("给新地图命名").setMessage("下载当前浏览的地图区域").setHint("输入名称").setOnClickBottomListener(new EditDialog.OnClickBottomListener() {
            @Override
            public void onPositiveClick() {
                String regionName =editDialog.getEditText();
                // Require a region name to begin the download.
                // If the user-provided string is empty, display
                // a toast message and do not begin download.
                if (regionName.length() == 0) {
            ...
            public void onNegativeClick() {
                editDialog.dismiss();
                Toast.makeText(Test.this,"ssss",Toast.LENGTH_SHORT).show();
            }
        }).show();
    ...
    private void downloadRegion(final String regionName) {
        ...
        map.getStyle(new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                float pixelRatio = Test.this.getResources().getDisplayMetrics().density;
                ...
                offlineManager.createOfflineRegion(definition, metadata, new OfflineManager.CreateOfflineRegionCallback() {
                    ...
                    public void onCreate(OfflineRegion offlineRegion) {
                        ...
                        Test.this.offlineRegion = offlineRegion;
                        launchDownload();
                    }
    ...
    private void downloadedRegionList() {
        ...
        offlineManager.listOfflineRegions(new OfflineManager.ListOfflineRegionsCallback() {
            ...
            public void onList(final OfflineRegion[] offlineRegions) {
                ...
                AlertDialog dialog = new AlertDialog.Builder(Test.this)
                        ...
                        .setPositiveButton(getString(R.string.navigate_positive_button), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                Toast.makeText(Test.this, items[regionSelected], Toast.LENGTH_LONG).show();
